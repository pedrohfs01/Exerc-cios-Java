...
public class TelaLeitor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite o número sorteado:(Entre 1 e 5) ");
        ...
        jLabel2.setText("O número sorteado foi:");
    ...
    private void btnSortearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSortearActionPerformed
        ...
        if(num == num2){
            ...
            lblResultado.setText("Parabéns você acertou! O número sorteado foi: "+num2);
        }
        else{
            lblResultado.setText("Que pena, você errou. O número sorteado foi: "+num2);
        }
